...
public interface SQLiteParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link SQLiteParser#explain_stmt}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitExplain_stmt(SQLiteParser.Explain_stmtContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link SQLiteParser#constraint_name}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitConstraint_name(SQLiteParser.Constraint_nameContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link SQLiteParser#object_name}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitObject_name(SQLiteParser.Object_nameContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link SQLiteParser#bind_parameter}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitBind_parameter(SQLiteParser.Bind_parameterContext ctx);
	/**
